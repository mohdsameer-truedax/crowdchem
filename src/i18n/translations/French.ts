const fr = {
  ...
  pillars: {
    title: "Les 3 Piliers de CrowdChem",
    gnn: "IA DEEP-TECH",
    gnnDesc: "Allez au-delà de l'IA générique. Notre plateforme conçue sur mesure capture l'essence même de la chimie, accélérant les percées et redéfinissant ce qui est possible dans l'innovation des matériaux.",
    data: "DATA NEXUS",
    dataDesc: "Accédez à l'un des plus grands ensembles de données chimiques vérifiées au monde pour débloquer des informations plus profondes et accélérer la découverte.",
    analysis: "Renseignement Fiable",
    analysisDesc: "Collaborez sans jamais partager vos données. Notre cadre sécurisé connecte les informations entre partenaires tout en gardant chaque ensemble de données protégé à sa source."
  },
  industries: {
    title: "NOS SECTEURS D'ACTIVITÉ",
    subtitle: "CrowdChem connecte les données et la découverte, libérant le potentiel de l'industrie tout en réduisant les coûts de R&D de 30 % et le délai de mise sur le marché de 50 %.",
    button: "EXPLORER NOS CAS D'USAGE"
  },
  collaborate: {
  ...
  news: {
    ...
    cta: "CONNECTONS-NOUS", // LET'S CONNECT
    readMore: "LIRE LA SUITE" // READ MORE
  },
  useStudies: {
    ...
    automotive_heading: "Innovation Automobile", // Automotive Innovation
    automotive_subheading: "Recherche de matériaux basée sur l'IA pour améliorer la performance et la durabilité des véhicules",
    automotive_description: "Notre travail dans le secteur automobile se concentre sur l'exploitation de la recherche de matériaux basée sur l'IA pour améliorer la performance, la durabilité et la sécurité des véhicules. En analysant des structures moléculaires complexes et en prédisant les comportements des matériaux, nous développons des composites légers qui améliorent l'efficacité énergétique et réduisent les émissions. Notre plateforme aide à concevoir avec précision des revêtements, des batteries et des composants structurels avancés, accélérant les cycles d'innovation tout en réduisant les coûts de prototypage. En collaboration avec les OEM et les fournisseurs, nous nous assurons que chaque matériau répond à des normes et des métriques de performance rigoureuses, permettant des véhicules plus intelligents, plus sûrs et plus durables pour l'avenir de la mobilité.",
    
    technology_title: "TECHNOLOGIE", // TECHNOLOGY
    technology_heading: "Développement de Semi-conducteurs", // Semiconductor Development
  ...
  applications: {
    ...
    subtitle: "Explorer les projets sélectionnés ci-dessous :" // Explore selected projects below:
  },
  contact: {
    subtitle: "Pour les demandes de partenariat et de vente :",
    category: "Catégorie :",
    name: "Nom",
    email: "E-mail",
    company: "Entreprise",
    message: "Message",
    send: "Envoyer",
    description: "Pour toutes autres demandes, envoyez un message à ",
    mail: "info@crowdchem.net",
    ourheadquarter: "BUREAUX",
    europe:"EUROPE",
    globalheadquarter: "SIÈGE SOCIAL MONDIAL",
    category1: "Partenariats", // ⬅️ ADDED
    category2: "Ventes",       // ⬅️ ADDED
    category3: "Recrutement",  // ⬅️ ADDED
    category4: "Presse",
    your: "Votre"
  },
  footer: {
    description: "Chez CrowdChem, nous poursuivons l'excellence dans chaque découverte, combinant rigueur scientifique et IA de pointe pour repousser les limites de l'innovation des matériaux. Notre engagement envers la précision, la sécurité et la collaboration pilote des solutions plus intelligentes qui façonnent un avenir plus avancé et durable.",
    headquarters: "SIÈGE SOCIAL MONDIAL",
    address1: "Japan, 〒140-0013 Tokyo",
    address2: " Shinagawa City, Minamioi,",
    address3:"6 Chome−16−4 戸浪大森ビル 6F",
    crowdchem: "CrowdChem",
    industries: "NOS SECTEURS",
    vision: "LA VISION",
    studies: "CAS D'USAGE",
    connect: "CONNEXION",
    contactUs: "CONTACTEZ-NOUS",
    careers: "X",
    siteName:"SITE JAPONAIS",
    linkedin: "LINKEDIN",
    copyright: "2025 CrowdChem. Tous droits réservés."
  },
  search: { // ⬅️ NEW SECTION
    title: "RECHERCHE",
    noresult: "AUCUN RÉSULTAT DE RECHERCHE POUR",
    result: "RÉSULTATS DE RECHERCHE POUR"
  },
  alt: {
    logo: "Logo CrowdChem",
    partnerLogo: "Logo de l'entreprise partenaire",
    newsImage: "Image de l'article de presse",
    applicationImage: "Projet d'application chimique"
  },
  brand: {
    name: "CrowdChem"
  },
  errors: {
    title_404: "Page Non Trouvée", // Page Not Found
    message_404: "Désolé, la page que vous recherchez n'existe pas.",
    title_500: "Erreur Serveur", // Server Error
    message_500: "Une erreur interne s'est produite. Veuillez réessayer plus tard.",
    offline_title: "Vous êtes hors ligne", // You’re Offline
    offline_message: "Vérifiez votre connexion Internet et réessayez.",
    home_link: "Aller à l'accueil", // Go Home
    contact_link: "Contacter le support" // Contact Support
  },
  "automotive": {
    "caseStudy": {
      "indexPrefix": "CAS",
      ...
      "levers": {
        ...
        "list": [
          "<1>Le paquet inorganique (ordre de surface et de contact) :</1> le talc traité, le TiO₂ rutile traité à l'alumine et la silice sphérique fine affûtent le maniement sur sol sec lorsqu'ils sont ajustés en faible quantité, sans provoquer d'écaillage.",
          "Inorganiques pour la neige (ancrage micro-mécanique) : le graphite expansé, l'alumine sphérique fondue et le talc traité au silane augmentent systématiquement l'indice de neige à faible dose, tout en respectant l'équilibre huile/charge.",
          "<1>Règles de l'ossature et de l'huile (fabricabilité) :</1> le cadre Caoutchouc Butadiène (BR) catalysé au Ti + Caoutchouc Naturel maintient la qualité d'extrusion avec peu d'huile ; changer les catalyseurs du BR rompt la processabilité même si d'autres paramètres « semblent corrects ».",
          "Pourquoi c'est important : vous vendez la confiance dans le freinage et la direction, avec la durabilité et un composé que l'usine peut réellement produire. Traduction commerciale : moins de défauts, moins de reprises, moins de gaspillage et moins d'essais."
        ]
      },
      "traceability": {
      ...
      "finalResults": {
        "heading": "Résultats Finaux",
        "table": {
    "headers": {
      "area": "Domaine",
      "before": "Avant, avec le processus typique",
      "after": "Après, avec l'IA de CrowdChem"
    },
    "rows": [
      {
        "area": "Objectifs et étapes clés",
        "process": "Critères variables",
        "after": "Indices secs/enneigés définis + extrusion = SUCCÈS"
      },
      {
        "area": "Recherche de formulation",
        "process": "Vaste essai et erreur",
        "after": "Liste restreinte (3-4 itinéraires) avec justification (processus inorganique par cible)"
      },
      {
        "area": "Ce qui est livré",
        "process": "Résultats ponctuels par exécution",
        "after": "Fenêtre opérationnelle (familles + plages) + garde-fous de processus"
      },
      {
        "area": "Fabricabilité",
        "process": "Découpe/brûlage des bords à faible teneur en huile",
        "after": "Extrusion propre selon les règles de faible teneur en huile avec Ti-BR"
      },
      {
        "area": "Itérations",
        "process": "De nombreuses exécutions ; des mois",
        "after": "Moins d'exécutions, des semaines pour atteindre le SUCCÈS"
      },
      {
        "area": "Itérations/Temps",
        "process": "De nombreuses exécutions ; des mois pour atteindre le 'SUCCÈS'",
        "after": "95 % moins d'exécutions, seulement des semaines pour atteindre le 'SUCCÈS'"
      }
    ]
  }
      },
  ...
  "cosmetics": {
    "caseStudy": {
      ...
      "traceability": {
        "heading": "Maintenir la confidentialité et la traçabilité",
        "content": "Vos données brutes restent de votre côté ; seuls les apprentissages du modèle sont déplacés. Cela signifie traçabilité de bout en bout ; vous pouvez suivre chaque essai, du lot au mélange, en passant par les tests jusqu'au résultat final. Cela rend le succès reproductible et les problèmes hors spécifications rapides à corriger."
      },
      "whatWeAreLookingFor": {
        "heading": "Ce que nous recherchons",
        "list": [
          "Une ossature de silicone filmogène qui sèche proprement et aide à prévenir le bavage.",
          "Ester d'acide gras de dextrine + argile organo-modifiée travaillant en synergie pour réduire l'agglomération et améliorer la redispersabilité.",
          "Pigments d'oxyde métallique hydrophobisés à charge élevée mais gérable pour une couleur intense.",
    ...
    "list": [
      ...
      "aiPlatformLook": {
        "heading": "À quoi ressemble cela avec notre plateforme d'IA",
        "list": [
          "<1>Une carte d'importance automatisée d'une page :</1> Notre plateforme crée une carte thermique claire montrant quels leviers affectent le plus la viscosité, la dispersion, la redispersabilité, la stabilité à haute température et l'anti-bavage. Cela accélère l'alignement entre la R&D, le marketing et les opérations. Plus le levier est rouge, plus il déplace les objectifs.",
          "<1>Liste courte explicable (3-5 routes) :</1> Chacune comprend le raisonnement et une bande de confiance. Où agir pour que votre laboratoire puisse confirmer rapidement. Des choix clairs, pas de boîte noire.",
          "<1>Fenêtre d'exploitation + garde-fous :</1> Plages pratiques pour le flux et la formation de film afin que les résultats se répètent sur les lots et les lignes."
        ]
      },
      "imageCaption": "Les routes sélectionnées qui atterrissent dans la fenêtre supérieure gauche offrent un anti-bavage en milieu humide et une remise en suspension facile, en ajustant ensemble le traitement des pigments, le filmogène et la structuration.",
      "meaning": {
        "heading": "Qu'est-ce que cela signifie ?",
        "list": [
          "<1>Redispersabilité</1>, nombre de mouvements nécessaires pour le remélange : plus à gauche = moins de mouvements (mieux) → donne une application nette et uniforme (pas de grain/traces).",
          "<1>Stabilité à haute humidité</1>, plus la valeur est proche de 1,0, mieux c'est : plus elle est élevée = bords plus nets après fixation (moins de bavage/effet de plume dans des conditions humides)."
        ]
      },
      "targetResults": {
        "heading": "Résultats de la fenêtre de style cible",
        "list": [
          "Les formules dans la fenêtre de viscosité se sont appliquées proprement et ont réduit le bavage.",
          "Les pigments hydrophobisés ont évité une agglomération sévère et se sont redispersés après sédimentation.",
          "La paire ester de dextrine + argile organoclay s'est comportée comme un levier à fort impact pour la stabilité à haute température et la redispersabilité.",
          "Une ossature huile volatile + filmogène a amélioré le séchage sans pousser la viscosité hors de la plage."
        ]
      },
      "quote1": "Le cas d'utilisation actuel a été entraîné avec des données publiques. Si des données combinées sont utilisées, la fiabilité prédictive s'améliore généralement de 20 % et plus par rapport à la base de référence publique uniquement (directionnel ; dépend de la profondeur des données).",
      "businessResults": {
        "heading": "Résultats commerciaux des cosmétiques à base d'huile",
        "list": [
          "<1>Meilleure expérience utilisateur :</1> glissement soyeux, rendu de couleur riche, pas de grain, pas de migration.",
          "<1>Moins de reformulations et de retours :</1> une stabilité et une redispersabilité plus fortes réduisent les retouches et les retards.",
          "<1>Mise à l'échelle en toute confiance :</1> une fois la fenêtre définie, elle se réplique ; la traçabilité la maintient en place. ",
          "Nous apprenons sur site, <1>vos données brutes ne partent jamais.</1> Seules les mises à jour du modèle sont partagées."
        ]
      },
      "finalResults": {
        "heading": "Résultats Finaux",
    ...
    "rows": [
      {
        "area": "Objectifs et étapes clés",
        "process": "Cibles peu claires",
        "after": "Défini : pas de saignement à l'humidité, re-dispersion facile et glisse soyeuse"
      },
      {
        "area": "Recherche de formulation",
        "process": "Vaste essai et erreur",
        "after": "Liste restreinte (3-4 itinéraires) avec justification : traitement de pigments hydrophobisés, filmogène, système de structuration"
      },
      {
        "area": "Ce qui est livré",
        "process": "Résultats ponctuels par lot",
        "after": "Fenêtre opérationnelle (familles + plages) avec garde-fous de processus"
      },
      {
        "area": "Itérations/Temps",
        "process": "Découpe/brûlage des bords à faible teneur en huile",
        "after": "90 % moins d'exécutions, des semaines pour atteindre le SUCCÈS"
      },
      {
        "area": "Connaissances ajoutées",
        "process": "De nombreuses exécutions ; convergence lente",
        "after": "Tous les aperçus du savoir-faire de l'industrie, sans risque de données"
      }
    ]
  }
      },
      "finalQuote": "En fin de compte, nous vous aidons à créer un meilleur produit, 50 % plus rapidement, et avec une plus grande sécurité. Avec notre plateforme, vous pouvez prendre des décisions basées sur des données solides, et non sur des conjectures, ce qui vous donne un avantage concurrentiel sur le marché et une réduction des coûts de 30 %."
    }
  },
  "advancedMaterials": {
    "caseStudy": {
      "indexPrefix": "CAS",
      "title": "",
      "subtitle": "Le Défi de l'Emballage Alimentaire Durable : Trouver l'Équilibre Parfait",
      "overview": {
        "heading": "Vue d'ensemble",
        "content1": "Dans la quête de solutions durables, les biorésines d'acide polylactique (PLA) sont apparues comme un matériau prometteur pour les feuilles de mousse utilisées dans les contenants alimentaires. <1>Mais si le marché du PLA est en croissance, le défi demeure :</1>",
      ...
      "traceability": {
        "heading": "Maintenir la confidentialité et la traçabilité",
        "content": "Vos données brutes restent de votre côté ; seuls les apprentissages du modèle sont déplacés. Cela signifie <1>traçabilité de bout en bout ;</1> vous pouvez suivre chaque essai, du lot au mélange, en passant par les tests jusqu'au résultat final. Cela rend le succès reproductible et les problèmes hors spécifications rapides à corriger."
      },
      "aiPlatformLook": {
        "heading": "Comment cela vous est présenté",
        "list": [
          "<1>Une carte d'importance automatisée d'une page.</1> Nous montrons les leviers les plus importants pour vos objectifs, ce qu'il faut ajuster, où cela se situe dans la formule et comment cela affecte <2>la douceur de la surface, le laminage/scellement et l'isolation.</2> C'est un visuel simple : plus le levier est rouge, plus il déplace vos objectifs.",
          "Une <1>liste courte explicable (3–5 routes)</1> à partir d'un océan d'options, réduite à un petit ensemble de <2>familles de composants</2> avec confiance et une brève explication (« pourquoi cela fonctionne »). Des choix clairs, pas de boîte noire.",
          "Une <1>fenêtre d'exploitation</1> prête pour les essais (comment <2>la taille des cellules, la densité</2> et <3>la formabilité</3> s'alignent) et <4>un plan de validation compact</4> que votre équipe connaît déjà : vérifiez la densité apparente, confirmez la taille des cellules et exécutez des contrôles de base de compression/thermoformage. Rapide à prouver, facile à mettre à l'échelle."
        ]
      },
      "imageCaption": "Les routes sélectionnées A–C atterrissent à l'intérieur de la fenêtre d'exploitation (rouge) où <1>les bulles fines + la densité moyenne-légère</1> offrent <2>des surfaces lisses et scellables et un formage propre</2>. La route D se situe à l'extérieur et dégrade l'apparence/le scellement.",
      "meaning": {
        "heading": "Qu'est-ce que cela signifie ?",
        "list": [
          "<1>Densité</1> : Plus léger à gauche, plus lourd à droite. Plus léger aide à l'isolation/au poids ; trop léger risque l'effondrement lors du formage.",
          "<1>Diamètre des bulles :</1> Plus élevé = meilleure adhérence/direction sur chaussée sèche"
        ],
      ...
      "businessValue": {
        "heading": "Valeur commerciale",
        "list": [
          "<1>Moins de reformulations, lancements plus rapides :</1> démarrez à l'intérieur de la bonne fenêtre ; contournez la boucle « surface rugueuse vs. effondrement » qui bloque les pilotes.",
          "<1>Performance différenciée : surfaces lisses et scellables</1> avec <2>une isolation utile</2> à la vitesse de la ligne, un avantage immédiat pour les barquettes alimentaires et les couvercles à emporter.",
          "<1>Position défendable :</1> Nous transformons l'essai et erreur en une <2>fenêtre d'exploitation prête à l'emploi</2>, les plages et la manière de les maintenir, créant un <3>véritable avantage en termes de délai de mise sur le marché.</3>"
        ]
      },
      "finalResults": {
        "heading": "Résultats Finaux",
    ...
    "rows": [
      {
        "area": "Objectifs et étapes clés",
        "process": "Critères incomplets ou changeants",
        "after": "Défini : Surface/Scellement = SUCCÈS, Thermoformage = SUCCÈS"
      },
      {
        "area": "Recherche de formulation",
        "process": "Vaste essai et erreur, avec des leviers peu clairs",
        "after": "Liste restreinte de 3-5 itinéraires avec des leviers clairs et un impact sur la formulation"
      },
      {
        "area": "Ce qui est livré",
        "process": "Résultats ponctuels par lot",
        "after": "Fenêtre opérationnelle, un algorithme d'apprentissage actif et des garde-fous de processus"
      },
      {
        "area": "Validation",
        "process": "Cycles et tests longs",
        "after": "Plan compact utilisant des données prouvées"
      },
      {
        "area": "Répétabilité de la ligne",
        "process": "Variable selon les équipes/outils",
        "after": "Méthodes de test éprouvées + garde-fous pour maintenir la fenêtre"
      },
      {
        "area": "Itérations/Temps",
        "process": "De nombreuses exécutions ; des mois pour atteindre le « SUCCÈS »",
