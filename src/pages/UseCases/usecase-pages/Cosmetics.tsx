...
const Cosmetics = ({ caseStudy, onClose }: { caseStudy: CaseStudy; onClose: (caseStudy: CaseStudy) => void }) => {
 ...
 const [moreMobileButon, setMoreMobileButon] = useState(false)
  ...
  const renderInterpListItem = (keyPath: string, index: number) => (
    <li className={`text-xs sm:text-sm md:text-base lg:text-lg xl92r:text-[1.125rem] 2xl:text-[1.3125rem] font-extralight ${baseTextStyle} ${index !== 0 && keyPath=== 'levers' ? 'mt-4' : 'mt-1'} sm:mt-0 ml-4`}>
      <TranslateHtml
       ...
       >
        ...
        <div className="w-full sm:w-1/2 text-[#000000] pt-4 sm:pt-0 lg:pt-[5.37vh]">
          ...
          <div className='w-[95%] pl-1.5 sm:pl-0'>
            ...
            {/* TITLE (Prop) */}
            <p className="text-xs sm:text-xl pt-1 sm:pt-0 md:text-2xl lg:text-[2rem] md:text-[2.0000rem] lg:text-[2.2800rem] xl92r:text-[2.5000rem] 2xl:text-[3rem] ml-2 lg:leading-[1] tracking-[0.05em] font-semibold sm:font-medium font-nunito  md:mt-[2.14vh]">
              {caseStudy.title}
            </p>
            ...
            <p className={`text-xs sm:text-sm sm:w-[34.72vw] md:text-base lg:text-lg md:text-[0.9583rem] lg:text-[1.0925rem] xl92r:text-[1.1979rem] 2xl:text-[1.4375rem] font-extralight ${baseTextStyle} tracking-[0.03em]`}>
              <TranslateHtml
...
<div className={`more sm:block pl-1.5 pr-3.5 sm:px-0 ${moreMobileButon ? 'block' : 'hidden'}`}>
      ...
      <div className=''>
        ...
        <p className={`text-xs sm:text-sm md:text-base lg:text-lg xl92r:text-[1.125rem] 2xl:text-[1.3125rem] font-extralight ${baseTextStyle} mt-0 sm:mt-0`}>
    ...
    {t('cosmetics.caseStudy.imageCaption')}
      ...
      {/* Quote 1 */}
       <div className='flex justify-center mt-6 mb-10 sm:my-[3.41vh] px-2.5 sm:px-0'>
         <p className="text-[1.5rem] sm:text-lg md:text-xl lg:text-2xl md:text-[1.6667rem] lg:text-[1.9000rem] xl92r:text-[2.0833rem] 2xl:text-[2.5rem] text-[#000000B2] italic font-bold font-nunito leading-[2.05rem] sm:leading-[1.865] mt-4 tracking-[0.01em] text-center">
