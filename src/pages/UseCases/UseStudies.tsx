...
const UseStudies = () => {
  ...
  return (
    <div className="pt-10 sm:pt-25 2xl:pt-30" id="useStudies">
      <section className="text-gray-600 body-font px-4 md:p-[2.86vh] pl-[1.375rem] lg:pl-[2.7rem] xl92r:pl-[3rem] 2xl:pl-[3.1265rem] pr-[2.9rem] lg:pr-[8.25rem] xl92r:pr-[9.16rem] 2xl:pr-[11rem]  pt-[2rem] lg:pt-[2.28rem] xl92r:pt-[2.5rem] 2xl:pt-[3rem] pb-8 sm:pb-[2.5rem] lg:pb-[2.81rem] xl92r:pb-[3.12rem] 2xl:pb-[3.75rem] relative bg-background3">
