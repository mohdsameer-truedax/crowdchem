...
const Collaborate = () => {
  ...
  return (
      ...
      <section className="body-font " style={{ backgroundColor: "#E5E5E5" }}>
        <div className=" mx-auto flex px-5 py-24 items-center justify-center flex-col">
          <div className="text-center  w-full flex flex-col items-center">
            <h2 className="title-font md:text-[2.625rem] mb-4 sm:mb-6 md:mb-8 lg:mb-10 text-2xl sm:text-3xl md:text-[2.0833rem] lg:text-[2.3750rem] xl:text-[2.6042rem] 2xl:text-[3.125rem] lg:leading-[6.25rem]  tracking-[0.00em] text-5xl font-semibold text-black font-nunito"
    ...
    lg:text-[1.425rem] 
    xl:text-[1.5625rem] 
    2xl:text-[1.875rem] font-deca font-extralight  md:leading-[3.75rem] lg:leading-[3.4375rem] w-full lg:w-3/4 2xl:w-1/2 tracking-[0.08em]">
    ...
    2xl:text-[1.875rem] md:leading-[3.75rem] lg:leading-[3.4375rem]  tracking-[0.08em]">{t('collaborate.desc')}</p>
            <button onClick={() => { navigate(`/contact?lang=${code || 'eng'}`); }} className="inline-flex font-light cursor-pointer md:text-[1.4583rem] lg:text-[1.6625rem] xl:text-[1.8229rem] 2xl:text-[2.1875rem] md:leading-[5.5rem]  tracking-[0.04em] items-center font-deca gap-2 border-3 border-gray-900 px-6 focus:outline-none hover:bg-white rounded-lg text-xl">
              {t('collaborate.cta')}
