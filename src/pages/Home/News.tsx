...
const News = () => {
  ...
  return (
    <section className="px-5 md:px-6 font-deca lg:px-10 xl92r:px-12 pt-4 sm:pb-6  sm:border-y-14 border-y-3 border-[#FCA311] bg-white overflow-hidden">
      {/* Header */}
      <div className=" items-center mb-8 flex-wrap gap-4">
        <div className="flex justify-between items-center" id='news'>
          <p className="text-[0.875rem] md:text-[1.25rem] font-regular lg:text-[1.4250rem] xl92r:text-[1.5625rem] 2xl:text-[1.875rem] lg:leading-[6.25rem]  tracking-[0.00em] font-deca font-normal"
