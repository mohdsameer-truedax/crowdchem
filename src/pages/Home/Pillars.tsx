...
const Pillars = () => {
  ...
  return (
    <div>
      <section className="body-font  px-6 sm:px-12 md:px-8 xl92r:px-14  2xl:pl-[4.375rem] pb-6 sm:pb-12"
      style={{backgroundColor:"#091B37"}}>
        ...
        <div className="mx-auto font-deca">
          <div className="flex items-center lg:w-3/5 mx-auto  mb-[1.25rem] lg:mb-[2.7rem] xl92r:mb-[3rem] 2xl:mb-[3.625rem] border-gray-200 sm:flex-row flex-col">
