...
const Industries = () => {
  ...
  return (
    <div id="industries">
      <ResponsiveBackground id="industry-bg" className="pt-10 pb-8 sm:pt-20 sm:pb-20 py-0 sm:py-20 text-gray-600 body-font bg-bottom bg-cover bg-no-repeat">
       ...
       <ResponsiveImage id="industries" alt="industries"  className="w-full h-full  my-8 md:my-15"/>
