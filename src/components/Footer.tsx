...
const Footer = () => {
  ...
  return (
    <footer className="px-2  md:px-8 lg:px-12 xl92r:px-16 font-deca text-white bg-background2  ">
      ...
      >
        ...
        <div className="w-full lg:w-5/12  flex flex-col md:flex-row order-1 lg:order-1">
          <h1  id='vision' className="text-[0.6875rem] sm:text-[1rem] md:text-[0.8333rem] lg:text-[0.9500rem] xl92r:text-[1.0417rem] 2xl:text-[1.25rem] font-normal   w-[88.20vw] sm:w-[50vw] xl:w-[31.26vw] leading-[1.64] sm:leading-[1.5] tracking-[0.08em] text-left">
            {t("footer.description")}<br/><br/>
               <p id='contact' className=" text-[0.6875rem] font-light  md:text-[0.75rem] lg:text-[0.8550rem] xl92r:text-[0.9375rem] 2xl:text-[1.125rem] leading-[1.45]  sm:leading-[1.66]  tracking-[0.08em] text-left">
     ...
     <div className="flex w-full lg:w-7/12 mt-10.5 sm:mt-1 flex-row justify-between gap-4 sm:gap-0 order-2 lg:order-2">
  {/* Crowdchem */}
  <div className="flex-1 w-1/3">
    <h2 className="title-font text-[0.625rem] font-medium  pt-1.5 sm:pt-0 mb-2 sm:mb-3 md:text-[0.8333rem] lg:text-[0.9500rem] xl92r:text-[1.0417rem] 2xl:text-[1.25rem] lg:leading-[1.875rem] tracking-[0.08em]">
      {t("footer.crowdchem")}
    </h2>
    <ul
      className="list-none font-normal text-[0.625rem] md:text-[0.6667rem] lg:text-[0.7600rem] xl92r:text-[0.8333rem] 2xl:text-[1rem] lg:leading-[1.875rem] tracking-[0.08em]"
      id="footer"
    >
        <li className="">
          <Link
  ...
  {/* Connect */}
  <div className="flex-1 w-1/3">
    <h2 className="title-font font-semibold sm:font-medium font-deca mb-2 pt-1.5 sm:pt-0 sm:mb-3 text-[0.625rem] md:text-[0.8333rem] lg:text-[0.9500rem] xl92r:text-[1.0417rem] 2xl:text-[1.25rem] lg:leading-[1.875rem] tracking-[0.08em]">
      {t("footer.connect")}
    </h2>
